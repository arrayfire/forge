...
IF(WIN32)
    SET(glbinding_location ${prefix}/lib/${CMAKE_SHARED_LIBRARY_PREFIX}glbinding${LIB_POSTFIX}${CMAKE_IMPORT_LIBRARY_SUFFIX})
ELSE(WIN32)
    SET(glbinding_location ${prefix}/lib/${CMAKE_SHARED_LIBRARY_PREFIX}glbinding${LIB_POSTFIX}${CMAKE_SHARED_LIBRARY_SUFFIX})
ENDIF(WIN32)
...
ADD_LIBRARY(glbinding IMPORTED SHARED)
